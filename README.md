...
enc_to_range.pd: For use with Rotary Encoders or any other incremental encoder. Takes an input (positive/negative increments of 1) and creates a virtual slider between 0 and 1. You can set the number of steps in between 0 and 1 in order to adjust the resolution.
